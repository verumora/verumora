  ...
  const handleGenerate = async () => {
    ...
    const imagePromise = generateProductConcept(prompt)
        .catch(error => {
            ...
            else if (msg.includes("404")) setErrorMsg("Image Gen: Model Not Found.");
        ...
        <div className="grid lg:grid-cols-2 gap-10 md:gap-20 items-center">
          ...
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 border border-neutral-800 rounded-full mb-6 md:mb-8">
                ...
                <span className="text-[10px] md:text-xs font-mono text-neutral-400 uppercase">POWERED BY ARTIFICIAL INTELLIGENCE</span>
            </div>
            ...
            {generatedImage ? (
              <div className="relative w-full h-full">
                  <ImageWithFallback
                    ...
                    fallbackSrc="https://images.unsplash.com/photo-1614726365723-49cfae9f0f94?auto=format&fit=crop&w=800&q=80" // Fallback to abstract if Pollinations fails
                  />
                  <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-black to-transparent p-6 md:p-8 z-20">
                      {generatedCopy && (
                        <>
                  ...
                  <button 
                    ...
                    className="absolute top-4 right-4 bg-black/50 hover:bg-black p-2 rounded-full backdrop-blur-md transition-all z-30"
                  >
                      <RefreshCw size={18} />
                  </button>
              </div>
