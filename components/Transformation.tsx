...
const CompareSlider: React.FC<{ item: ComparisonItem }> = ({ item }) => {
  ...
  return (
    <div className="mb-12 md:mb-24 last:mb-0">
      ...
      <div 
        ref={containerRef}
        className="relative w-full aspect-[4/3] md:aspect-[21/9] overflow-hidden cursor-ew-resize select-none group touch-pan-y touch-action-none rounded-sm md:rounded-none bg-neutral-900"
